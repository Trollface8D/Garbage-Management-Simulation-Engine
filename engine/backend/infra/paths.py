...
DEFAULT_MAP_EXTRACT_NODE_RESPONSE_SCHEMA = BACKEND_DIR / "app" / "response_schema" / "map_extract_nodes.schema.json"
DEFAULT_MAP_EXTRACT_EDGE_RESPONSE_SCHEMA = BACKEND_DIR / "app" / "response_schema" / "map_extract_edges.schema.json"
